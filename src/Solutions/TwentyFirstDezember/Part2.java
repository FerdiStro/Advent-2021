...
public class Part2 extends Scann {

    public final int[] MULTS = { 1, 3, 6, 7, 6, 3, 1 };
    public long Solution(){
        List<String> input = this.scannFile("rsc/input21Dezember.txt");
        ...
        int p1pos = Integer.parseInt(input.get(0).split(": ")[1]);
        int p2pos = Integer.parseInt(input.get(1).split(": ")[1]);
